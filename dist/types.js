...
//~  Generic Array<Genereic>
const arrayIsDiferentType = [1, 'String'];
const arrayIsDiferentTypeGeneric = ['String', 1];
//~ ? 
const arrayIsMaybeType = ['Something'];
...
unknownType = {};
let someNumber = 1;
let someNumberType = someNumber;
let someNumberTypeForAs = someNumber;
